...
It is very easy to host your own launch web server.
...
Clone the repository and build the `Dockerfile` using: `docker build -t linwood-launch`.
Start the server using: `docker run -p 8080:8080 -d linwood-launch`.
