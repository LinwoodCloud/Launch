...
<a className="button button--outline button--danger button--lg margin--sm" href="https://github.com/LinwoodCloud/launch/releases/download/nightly/linwood-launch-macos.tar.gz">
  Nightly
</a>
</div>
